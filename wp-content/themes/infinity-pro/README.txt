...
= 1.3.3 =
* Fixed: prevent "_load_textdomain_just_in_time was called incorrectly" notices by calling genesis_register_sidebar in after_setup_theme.

= 1.3.2 =
* Added: CSS styles for WordPress 5.4 Social Icons.
* Added: Editor styles to ensure theme colors work for inline text colors.
* Changed: Editor styles for WordPress 5.4 compatibility, including link color, buttons, and lists.
