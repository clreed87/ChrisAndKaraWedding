...
add_action( 'after_setup_theme', 'infinity_register_sidebar' );

/**
 * Registers sidebar.
 *
 * @since 1.3.3 Moved from file root to prevent notices about using translations
 * before the after_setup_theme hook under WP 6.7+.
 */
function infinity_register_sidebar() {
